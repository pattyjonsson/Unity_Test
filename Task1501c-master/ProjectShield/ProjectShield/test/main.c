...
int main(void)
{
	...
	UnityBegin("../test/test_analog.c");
	RUN_TEST(test_ADConverterInitialisesProperly, 50);
	//RUN_TEST(test_ADConverterReadsValueWithNoButtonPressed, 35);------------------/*Kanske inte behöver ha detta  */
	UnityEnd();
